angular.module('app.translations', []).constant('translations', {
    srb: {
        ...
        'visit-cont5': 'Такође, у могућности смо да угостимо мање и веће групе посетилаца са седећим капацитетом на отвореном од 60 места и затвореном 80 места. Уз дегустацију наших вина, служимо и традициона војвођанска предјела типична за Јужни Банат.',
    ...
    en: {
        ...
        'visit-cont5': 'Also, we are able to host small and large groups of visitors offering 60 seats outdoors and 80 seats indoors. While tasting our wines, the visitors are offered some traditionalism Vojvodina appetizers and meals typical for the South Banat.',
